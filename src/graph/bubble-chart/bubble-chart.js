...
function bubbleChart() {
  ...
  function showDetail(d) {
    ...
    var content = '<span class="name">Loja: </span><span class="value">' +
                  d.name +
                  '</span><br/>' +
                  '<span class="name">Spending: </span><span class="value">R$' +
                  addCommas(d.value) +
                  '</span><br/>' +
                  '<span class="name">Shopping: </span><span class="value">' +
                  d.year  +
                  '</span>';
...
//  d3.json('api/bubble-chart.json', display);
  display(null, data);
